...
const findByEmail = async (email) => {
    try {
        ...
        const find = await service.findByEmail(email);
...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        const findUser = await service.findByEmail(email);
        ...
        const register  = await service.registerUser(req.body);
...
const updateUser = async (req, res) => {
    ...
    try {
        ...
        const update  = await service.updateUser(req.body);
